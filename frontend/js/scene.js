...
export function purgeDetachedSpaChannelArtifacts(scene, activeGroup = null) {
...
function addCircularChannelExtrude(group, shape, depth, localZ, center, quat, material, tileSize = 0.3) {
  ...
  generateMeterUVsForCircularRingGeometry(geo, tileSize);
...
export function updateGroundVoid(ground, poolGroup, spaGroup = null) {
  ...
  purgeDetachedSpaChannelArtifacts(scene, ground?.userData?.spaChannelGroup || null);
  ensureGroundSpaClipMaterial(ground);
